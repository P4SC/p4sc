...
metadata openstate_routing_metadata_t openstate_routing_metadata;
...
action forward(eth_dst,ip_dst,tcp_dst) {
    ...
    modify_field(openstate_routing_metadata.ipv4Length, ipv4.ihl);
    add_to_field(openstate_routing_metadata.ipv4Length, ipv4.ihl);
    add_to_field(openstate_routing_metadata.ipv4Length, ipv4.ihl);
    add_to_field(openstate_routing_metadata.ipv4Length, ipv4.ihl);
    modify_field(openstate_routing_metadata.tcpLength, ipv4.totalLen);
    subtract_from_field(openstate_routing_metadata.tcpLength, openstate_routing_metadata.ipv4Length);
...
control process_fwd_consistency {
